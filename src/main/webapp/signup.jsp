    ...
    <div class="card">
        ...
        <form action="SignupServlet" method="post">
            <div class="input-group">
                <label>お名前 (ログインID用)</label>
                <input type="text" name="userName" required placeholder="例：湘南 太郎">
            </div>
            <div class="input-group">
                <label>メールアドレス</label>
                <input type="email" name="userMail" required placeholder="example@shonan.co.jp">
            </div>
